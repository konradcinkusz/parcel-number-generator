...
| DEV-4 | No CodeQL/SAST job in CI | REPO-BASELINE §1 | 2026-08-15 | Blocked on GitHub Advanced Security or the repository going public |
...
precondition, not a follow-up. Then restore the job from the comment.
